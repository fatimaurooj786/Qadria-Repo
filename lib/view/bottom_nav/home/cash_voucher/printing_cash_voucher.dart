...
class PrintingCashVoucher extends StatefulWidget {
  const PrintingCashVoucher({
    super.key,
    required this.voucher,
  });
  final CashVoucherDetailModel voucher;

  @override
  _PrintingCashVoucherState createState() => _PrintingCashVoucherState();
}

class _PrintingCashVoucherState extends State<PrintingCashVoucher> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Print Cash Voucher",
